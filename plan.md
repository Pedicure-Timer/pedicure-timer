...
4. Mô hình dữ liệu và máy trạng thái: làm một phần.
5. Luồng nghiệp vụ và quyết định sản phẩm: làm một phần.
6. Thiết kế giao diện và trải nghiệm demo: làm một phần.
7. Lộ trình build, test và bàn giao: làm một phần.
8. Bản bàn giao: làm một phần.

Chưa có rõ ràng trong code hiện tại:
